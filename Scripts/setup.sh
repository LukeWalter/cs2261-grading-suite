...
# NOTE: Make sure to switch out the tasks.json file here with your own!
...
# NOTE: Make sure you're in the Scripts folder when running any of these commands (And that you're using a WSL terminal!)
